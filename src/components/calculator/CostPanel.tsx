...
import { CostingSettings, CostingBasedOn, RoundingStep } from '@/lib/types'
            ...
            <div className="px-4 py-3 space-y-4">
              <div className="space-y-2">
                ...
                <Select value={settings.basedOn} onValueChange={handleBasedOnChange}>
                  <SelectTrigger id="costing-based-on" className="w-full">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div className="space-y-2">
                ...
                <Select value={settings.roundingStep.toString()} onValueChange={handleRoundingStepChange}>
                  <SelectTrigger id="rounding-step" className="w-full">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
